    ...
    def __init__(self, writer_dir, logger, enable):
        ...
        if enable:
            ...
            try:
                ...
                message = """TensorboardX visualization is configured to use, but currently not installed on this machine. Please install the package by 'pip install tensorboardx' command or turn off the option in the 'config_file.json' file."""
